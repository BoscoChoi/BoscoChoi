...
| **Hong Kong Planning Infohub**    | This app allows planning application documents to be accessed seamlessly using an interactive geospatial portal, bridging the existing gap between the Town Planning Board Statutory Planning Portal 3 (SPP3) and Town Planning Board's document records on its website. It runs by fetching live api data from the HK CSDI directly.    | [View App](https://boscochoi.github.io/HK_Planning_Infohub/)    |
